...
public class DrinksActivity extends AppCompatActivity {
    ...
    private void setImagePoster(String keyword) {
        if (keyword.equalsIgnoreCase("gin")){
            ...
            Picasso.get()
                    ...
                    .fit()
                    .into(imagePoster);
        }else if (keyword.equalsIgnoreCase("soft_drinks")){
            Picasso.get()
                    .load("https://liquorstore.mblog.co.ke/images/soft_drinks1.jpg")
                    .fit()
                    .into(imagePoster);
        }else {
            Picasso.get()
    ...
    public ArrayList<Drink> extractDrinks(JSONObject response) {
        JSONArray array;
        JSONObject object;
    ...
    public void getDrinks(String keyword) {
